...
const headPath = path.join(
  __dirname,
  '../__tests__/fixtures/gold_coverage_head.json'
)
...
const usersController =
  '/Users/git/private/example_app/app/controllers/users_controller.rb'
...
coverage[
  '/Users/git/private/example_app/app/services/user_deletion_service.rb'
] = {
  lines: [
    null,
    null,
...
delete coverage[
  '/Users/git/private/example_app/app/helpers/ai_models_helper.rb'
]
...
const appHelper =
  '/Users/git/private/example_app/app/helpers/application_helper.rb'
...
const factualEval =
  '/Users/git/private/example_app/app/evaluators/factual_accuracy_evaluator.rb'
...
coverage[searchTask].branches['[:unless, 0, 54, 4, 54, 41]'][
  '[:then, 2, 54, 4, 54, 10]'
] = 5
